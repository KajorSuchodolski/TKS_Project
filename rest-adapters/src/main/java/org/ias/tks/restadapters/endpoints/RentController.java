...
//import org.ias.tks.restadapters.ports.RentRestPort;
//
...
//
//    @Inject
//    private RentRestPort rentRestPort;
//
//    // CREATE
//    @POST
...
//        }
//        try {
//            rentRestPort.addRent(login, costumeIds, date);
...
//        return Response.ok().entity(rentRestPort.getAll()).build();
//    }
//
//    @GET
...
//        return Response.ok().entity(rentRestPort.getAllCurrent()).build();
//    }
//
//    @GET
//    @Path("/{id}")
...
//        try {
//            return Response.ok()
//                    .entity(rentRestPort.getRentById(UUID.fromString(rentId)))
//                    .build();
...
//        }
//        try {
//            return Response.ok().entity(rentRestPort.userCurrentRents(login)).build();
...
//        }
//        try {
//            return Response.ok().entity(rentRestPort.userPastRents(login)).build();
//        } catch (UserByLoginNotFound e) {
//            return Response.status(Response.Status.NOT_FOUND).entity(e.getMessage()).build();
//        }
//    }
...
//                    .entity(rentRestPort.getCostumeAllocations(UUID.fromString(costumeId)))
//                    .build();
...
//        }
//        try {
//            rentRestPort.removeRent(UUID.fromString(rentId));
//            return Response.ok(Response.Status.OK)
...
//        }
//        try {
//            rentRestPort.endRent(date, UUID.fromString(rentId));
//            return Response.ok(Response.Status.OK)
